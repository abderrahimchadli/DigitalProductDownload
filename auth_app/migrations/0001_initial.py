# Generated by Django 3.2.16 on 2023-12-09 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variatid', models.TextField(default=None, null=True)),
                ...
                ('url', models.TextField(default=None, null=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.order')),
